...
(:objects
    t1 t2 t3 t4 - transportador
	n0 n1 n2 n3 n4 - numero
    d1 d2 d3 d4 - dron
	gripper_1_left gripper_1_right gripper_2_left gripper_2_right gripper_3_left gripper_3_right gripper_4_left gripper_4_right - gripper
...
(:init
    ...
    (transportador-not-carry t3)
    (transportador-not-carry t4)
    ...
    (gripper-assign d3 gripper_3_left)
    (gripper-assign d3 gripper_3_right)
    (gripper-assign d4 gripper_4_left)
    (gripper-assign d4 gripper_4_right)

	(dron-at d1 location_deposito)
    (dron-at d2 location_deposito)
    (dron-at d3 location_deposito)
    (dron-at d4 location_deposito)
    ...
    (free gripper_3_left)
    (free gripper_3_right)
    (free gripper_4_left)
    (free gripper_4_right)

	(transportador-at t1 location_deposito)
	(transportador-at t2 location_deposito)
    (transportador-at t3 location_deposito)
    (transportador-at t4 location_deposito)
	...
	(person-dont-have person4 medicine)
	(person-dont-have person5 food)
	(person-dont-have person5 medicine)
