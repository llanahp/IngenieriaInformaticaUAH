	...
	for x in range(options.persons):
		...
		for y in range(len(content_types)):
			...
			if (x % len(content_types) != y):
				...
				f.write("\t(person-doesnt-have "+person_name+" "+content_name+")\n")
...
def main():
	...
	with open("./problems/"+problem_name + ".pddl", 'w') as f:
		...
		for x in range(options.drones):
			dron_name = drone[x]
			f.write("\t(gripper-at "+dron_name+"1 location_deposito)\n")
			f.write("\t(gripper-at "+dron_name+"2 location_deposito)\n")
			f.write("\t(gripper-at "+dron_name+"3 location_deposito)\n")
			f.write("\t(gripper-at "+dron_name+"4 location_deposito)\n\n")

			f.write("\t(free "+dron_name+"1)\n")
			f.write("\t(free "+dron_name+"2)\n")
			f.write("\t(free "+dron_name+"3)\n")
			f.write("\t(free "+dron_name+"4)\n\n")

			f.write("\t(gripper-group "+dron_name+"1 "+dron_name+"2 "+dron_name+"3 "+dron_name+"4)\n\n")
