...
object Comprobaciones {
  ...
  def esColumnaVacia(columna: ParVector[Int]): Boolean = {
    if (!columna.isEmpty) {
  ...
  def existenColumnasVacias(columna: Int, tablero: ParVector[Int], nivel: Int): ParVector[Int] = {
  ...
  def quedanBloques(tablero: ParVector[Int]): Boolean = {
  ...
  def cuantosIgualesIzquierda(posicion: Int, tablero: ParVector[Int], nivel: Int): Int = {
  ...
  def cuantosIgualesDerehca(posicion: Int, tablero: ParVector[Int], nivel: Int): Int = {
  ...
  def cuantosIgualesAbajo(posicion: Int, tablero: ParVector[Int], nivel: Int): Int = {
  ...
  def cuantosIgualesArriba(posicion: Int, tablero: ParVector[Int], nivel: Int): Int = {
  ...
  def puntosBomba(posicion: Int, tablero: ParVector[Int], nivel: Int): Int = {
  ...
  def cuantosBloquesAlrededor(posicion: Int, tablero: ParVector[Int], nivel: Int, recorrido: Int): Int = recorrido match {
    case 0 => {
