...
object MostrarInfo {
  ...
  def imprimir(l: ParVector[Int], nivel: Int): Any = nivel match {
  ...
  def imprimirPantalla(l: ParVector[Int], filas: Int, columnas: Int): Any = {
  ...
  def posicionCorrecta(posicion: Int, tablero: ParVector[Int], nivel: Int): Int = {
