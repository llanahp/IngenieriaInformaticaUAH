...
__global__ void convolucion(const int* a, const int* b, int* c)
{
...
int main()
{
	...
	//Declaramos un grid de un bloque y un bloque de threads de width * width
	dim3 dimGrid(1, 1);
	dim3 dimBlock(width, width);


	//Ejecutamos la funcion
	convolucion << < dimGrid, dimBlock >> > (primeraMatrizD, segundaMatrizD, resultadoD);
